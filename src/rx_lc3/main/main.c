...
// Zmienne do buffer_monitor_task
...
// Znajdź wolny slot w puli — wołane tylko z callbacku
...
// DEKODER LC3 + MASKOWANIE (Rdzeń 0)
...
void audio_playback_task(void *pvParameters) {
    ...
    while (1) {
        // Pre-buffering: czeka na 25% zapełnienia przed startem odtwarzania
        if (buffering) {
